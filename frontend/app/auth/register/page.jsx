...
export default function RegisterPage() {
    ...
    const handleRegister = async (e) => {
        ...
        try {
            await register(username, phone, gender)
    ...
    return (
        <div className="min-h-screen w-full flex">
            ...
            <div className="hidden md:flex w-[40%] relative">
                <Image
                    src="https://images.unsplash.com/photo-1617742696157-3d806a7af677?q=80&w=1374&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                ...
                <div className="absolute bottom-8 left-8 right-8 text-white">
                    ...
                    <p className="text-sm opacity-90">Join thousands of users who trust our platform for their consultaion .</p>
                </div>
            </div>
